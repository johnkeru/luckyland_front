        ...
        <tr className='border-b-2'>
            ...
            <td className='border border-gray-300'>
                <span className="flex gap-2 items-center ml-2">
                    {emp.roles.map((role, index) => <RoleChip key={index} roleName={role.roleName} />)}
                </span>
            </td>
            <td className='text-md font-semibold border border-gray-300 p-2'>
                <span className='flex gap-2'>
                    <Details_Employee_Modal
                        button={<ButtonIcon title='info' color='blue'>
                            <FaInfo className='w-4 h-4' />
                        </ButtonIcon>}
                        empDetails={emp}
                    />
                    <ViewLogs_Employee_Modal
                        button={<ButtonIcon title='activity logs' color='teal'>
                    ...
                    <Add_Employee_Modal
                        ...
                        button={<ButtonIcon title='edit' color='orange'>
