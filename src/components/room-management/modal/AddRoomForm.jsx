...
const AddRoomForm = ({ defaultValues, register, errors, setValue, isCottage, isOther }) => {
    ...
    return (
        <Box >
            <Typography gutterBottom variant='h6'>{!isCottage ? 'Room' : isOther ? 'Other' : 'Cottage'} Details</Typography>
