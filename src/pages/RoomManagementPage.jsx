...
const RoomManagementPage = () => {
    ...
    return (
        <Grid>
            ...
            <Box bgcolor='background.white' boxShadow={2} p={2} mb={1.5} display='flex' ml='auto' gap={2} alignItems='center' justifyContent='end'>
            ...
            <Box bgcolor='background.white' boxShadow={2} p={2} mb={1.5} display='flex' flexDirection='column' alignItems='start' gap={2}>
            ...
            <Box bgcolor='background.white' boxShadow={2} p={2} mb={1.5}>
                ...
                <Box display='flex' flexWrap='wrap' justifyContent='space-between' width='100%' gap={2}>
                    {
                        loading ? <RoomLoading isRoomManagement /> :
                            rooms.filter(room => room.active).map(room => <Room key={room.id} getAllRooms={getAllRooms} room={room} />)
                    }
                </Box>
            </Box>

            <Box mb={1.5} bgcolor='background.white' boxShadow={2} p={2}>
