...
const Step1 = ({ register, errors, user, setValue }) => {
    ...
    return (
        <>
            ...
            {!user ? <InputIcon setValue={setValue} isView defaultValue={user?.password} Icon={RiLockPasswordFill} label='Password' name='password' register={register} errors={errors} placeholder='Enter Password' type='password' /> : undefined}
        </>
    );
};
